...
export { default as WaQrSylwiaStachow } from './wa-qr-code-ss.svg'
export { default as ArtistryLogo } from './artistry.svg'
export { default as NutriliteLogo } from './nutrilite.svg'
