    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
      <defs>
        <clipPath id="clip-path-dot-color">
          ...
          <circle cx="250" cy="442" r="8" transform="rotate(0,250,442)" />
          ...
          <circle cx="282" cy="378" r="8" transform="rotate(0,282,378)" />
          ...
          <circle cx="474" cy="474" r="8" transform="rotate(0,474,474)" />
          <path
            clipRule="evenodd"
